...
type LogEntry struct {
	...
	Severity      Severity               `protobuf:"varint,2,opt,name=severity,proto3,enum=lad.Severity" json:"severity,omitempty"`
...
const file_proto_log_proto_rawDesc = "" +
	"\n" +
	"\x0fproto/log.proto\x12\x03lad\"m\n" +
	"\bLogEntry\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x03R\ttimestamp\x12)\n" +
	"\bseverity\x18\x02 \x01(\x0e2\r.lad.SeverityR\bseverity\x12\x18\n" +
	...
	"\x05FATAL\x10\x04B\x1fZ\x1dgithub.com/Manny-14/LAD/protob\x06proto3"
...
var file_proto_log_proto_goTypes = []any{
	(Severity)(0),    // 0: lad.Severity
	(*LogEntry)(nil), // 1: lad.LogEntry
}
var file_proto_log_proto_depIdxs = []int32{
	0, // 0: lad.LogEntry.severity:type_name -> lad.Severity
